function result = intersectTimes(varargin)
% This function intersects two sets of time inclusion ranges

result = varargin{1};

for i = 2:numel(varargin)
    result = intersect(result,varargin{i});
end

    function out = intersect(first,second)
        ...
        %
        % Ryan Y - modification to accept and output Nx2 matrices
